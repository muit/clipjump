...
(function() {
  var BCSocket, Connection, Doc, MicroEvent, ReconnectingWebSocket, SockJS, WebSocket, append, bootstrapTransform, checkMop, checkValidComponent, checkValidOp, exports, hasBCSocket, hasSockJS, invertComponent, meta, metadata, nextTick, socketImpl, strInject, text, transformComponent, transformPosition, types,
    __slice = [].slice,
  ...
  Doc = (function() {
    ...
    Doc.prototype._mopApply = function(mop, isRemote) {
      ...
      if (mop.n) {
        this.emit('metanew', mop.n);
      }
      if (mop.as) {
        this.emit('metainsert', mop.id, mop.as);
      }
      if (mop.rs) {
        return this.emit('metaremove', mop.id, mop.rs);
      }
    };
    ...
    Doc.prototype._onMessage = function(msg) {
      ...
      switch (false) {
        ...
        case !(msg.op === null && error === 'Op already submitted'):
          break;
        case !((msg.op === void 0 && msg.mop === void 0 && msg.v !== void 0) || (msg.op && (_ref = msg.meta.source, __indexOf.call(this.inflightSubmittedIds, _ref) >= 0))):

...
Trigger.prototype.reset=function(){this.s=void 0};Vector2=function(a,b){a instanceof Vector2?(this.x=a.x,this.y=a.y):(this.x=a,this.y=b)};Vector2.prototype.x=null;Vector2.prototype.y=null;Vector2.prototype.distance=function(a){return Vector2.distance(this,a)};Vector2.distance=function(a,b){return Math.sqrt(Math.pow(b.x-a.x,2)+Math.pow(b.y-a.y,2))};Vector2.dot=function(a,b){return a.x*b.x+a.y*b.y};
Vector3=function(a,b,c){a instanceof Vector3?(this.x=a.x,this.y=a.y,this.z=a.z):(this.x=a,this.y=b,this.z=c)};Vector3.prototype.x=null;Vector3.prototype.y=null;Vector3.prototype.z=null;Vector3.prototype.distance=function(a){return Vector3.distance(this,a)};Vector3.distance=function(a,b){return Math.sqrt(Math.pow(b.x-a.x,2)+Math.pow(b.y-a.y,2)+Math.pow(b.z-a.z,2))};Vector3.dot=function(a,b){return a.x*b.x+a.y*b.y+a.z*b.z};EventMap=function(){};EventMap.prototype.events=[];
